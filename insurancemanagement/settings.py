...
INSTALLED_APPS = [
    ...
    'widget_tweaks',
    'insurance.app.InsuranceConfig',
    'customer.app.CustomerConfig',
]
...
DATABASES = {
    ...
    'default': {
        ...
        'HOST': "db.wcaftyrivltlzpcfyjhz.supabase.co",
        'NAME': "postgres",
        'USER': "postgres",
        'PASSWORD': "n11PfddFUvhfiE9a",
        'PORT': "5432",
    }
}
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'icvc.a10@gmail.com' # this email will be used to send emails
EMAIL_HOST_PASSWORD = 'loxefvqlixhjyfax' # host email password required
